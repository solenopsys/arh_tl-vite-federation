...
export const ProductionPlugin = (): Plugin => {
    ...
    return {
        ...
        async transform(code, id) {
            ...
            if (
                id.includes('node_modules') ||                code.includes('@nitedani/vite-plugin-angular/client')
            ) {

                // if (id.includes('angular/router')){
                //     console.log("SKIP----------------\n", id)
                //
                //    const babelResult= await linkLibrary(code,"C:\\dev\\sources\\MAIN\\temp5\\frontends\\dist\\router-link.js")
                //
                //     return {
